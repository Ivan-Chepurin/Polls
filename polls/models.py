...
class AnonUserId(models.Model):
    ...
    auth_user = models.OneToOneField(settings.AUTH_USER_MODEL, null=True, on_delete=models.DO_NOTHING)
...
class Question(models.Model):
    ...
    type = models.CharField(max_length=2, choices=TYPES, default='OA', verbose_name='тип вопроса')
...
class Answer(models.Model):
    user = models.ForeignKey(AnonUserId, on_delete=models.DO_NOTHING, verbose_name='ID пользователя', null=True)
    question = models.ForeignKey(Question, on_delete=models.CASCADE, verbose_name='вопрос')
    choice = models.ForeignKey(Choice, on_delete=models.CASCADE, verbose_name='вариант ответа', null=True, blank=False, default=None)
